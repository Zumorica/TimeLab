...
/mob/living/human/proc/DRAW_TEXT(var/text_string,var/screen_x,var/screen_y,var/pixel_x_offset,var/pixel_y_offset,var/m_id,var/image_name)
	...
	while(char_pos < char_len+1)
		...
		if(T != " ")
			var/image/I = image('images/HUDFont.dmi',H,"[T]",22)
...
/mob/living/human/proc/TEXT_MENU_ID(var/m_id,var/screen_x,var/screen_y)
	var/obj/HUD/H = locate("[m_id] [screen_x],[screen_y]")
	return H



/mob/living/human/proc/CLEAR_TEXT(var/m_id,var/image_name)

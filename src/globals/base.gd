...
const element = preload("res://src/element/element.gd")
const mob = preload("res://src/mob/mob.gd")
const client = preload("res://src/client/client.gd")
...
const inventory_scene = preload("res://src/GUI/Inventory/Inventory.tscn")
const weapon = preload("res://src/item/weapon/weapon.gd")